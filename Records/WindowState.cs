...
public record WindowState
{
    ...
    public void DrawItem(Item? item, uint neededCount = 0, string key = "Item", bool showIndicators = false, TerritoryType? territoryType = null)
    {
        ...
        {
            ImGuiUtils.ContextMenuEntry.CreateSearchCraftingMethod(item),
            ImGuiUtils.ContextMenuEntry.CreateSearchGatheringMethod(item),
            ImGuiUtils.ContextMenuEntry.CreateOpenMapForGatheringPoint(item, territoryType),
            ImGuiUtils.ContextMenuEntry.CreateOpenMapForFishingSpot(item, territoryType),
            ImGuiUtils.ContextMenuEntry.CreateOpenInFishGuide(item),
            ImGuiUtils.ContextMenuEntry.CreateSeparator(),
            ...
            ImGuiUtils.ContextMenuEntry.CreateOpenOnGarlandTools(item.RowId),
        }
        .Draw();
